---
title: "Memetics (Part 1)"
posted: 2025-09-16T03:23:54.752Z
part: 1
draft: false
---
...
![](https://39669.cdn.cke-cs.com/rQvD3VnunXZu34m86e5f/images/91d11a8fbc8267de4e6a94bcdcc9c378c6911e4d3f65458b.jpg)

> ~[Baby shark doo doo doo doo doo doo](https://youtu.be/XqZsoesa55w?list=RDXqZsoesa55w&t=30)~

Internet memes: [copy pastas](https://www.reddit.com/r/LowSodiumCyberpunk/comments/10lnbna/what_the_fuck_did_you_just_fucking_say_about_me/), [chain mail](https://en.wikipedia.org/wiki/Chain_letter), [image macros](https://en.wikipedia.org/wiki/Image_macro).

[Earworms](https://en.wikipedia.org/wiki/Earworm). [The lick](https://www.youtube.com/watch?v=krDxhnaKD7Q).

*Zoom out.*

[Spread the word to end the word](https://en.wikipedia.org/wiki/Spread_the_Word). [ALS Ice Bucket Challenge](https://en.wikipedia.org/wiki/Ice_Bucket_Challenge). Breast Cancer Awareness.

Fads. [School shootings](https://en.wikipedia.org/wiki/Copycat_crime).

[Meme stocks](https://en.wikipedia.org/wiki/GameStop_short_squeeze). [Meme coins](https://en.wikipedia.org/wiki/Meme_coin). [Tulip mania](https://en.wikipedia.org/wiki/Tulip_mania).

[Dancing mania](https://en.wikipedia.org/wiki/Dancing_mania), "[spirit possession](https://en.wikipedia.org/wiki/Haitian_Vodou#Spirit_possession)", [culture-bound](https://en.wikipedia.org/wiki/Culture-bound_syndrome) mental [illness](https://en.wikipedia.org/wiki/Mass_psychogenic_illness) (e.g. [anorexia, depression, and PTSD](https://www.astralcodexten.com/p/book-review-crazy-like-us)).
...
Examples of memes: ideas, stories, ideologies, jokes, narratives, brands, identities, habits, practices.[^nh088dn6gcg]
...
Memes[^eibk3lo1f] are replicators. When you share an internet meme with a friend or repost it on X, the meme is replicating. Two young men ask you if you have a moment to talk about Jesus -- the meme\[plex\] is trying to replicate.
...
![](https://39669.cdn.cke-cs.com/rQvD3VnunXZu34m86e5f/images/efa980ad2ac279b35de99795957e0ec608081ded691aa97a.png)
...
There's [a](https://www.lesswrong.com/s/6xgy8XYEisLk3tCjH) whole [host](https://www.lesswrong.com/posts/RmCjazjupRGcHSm5N/professing-and-cheering) of [theories](https://www.lesswrong.com/posts/nYkMLFpx77Rz3uo9c/belief-as-attire) about [why](https://www.lesswrong.com/posts/TGzYTkmrtaE4yuEch/people-don-t-have-beliefs-any-more-than-they-have-goals) people believe things on this website. Indeed, it's a central question in the development of "[the art](https://www.lesswrong.com/w/rationality) of thinking in ways that result in accurate beliefs and good decisions."

(Reminder: [all models are wrong, but some are useful](https://en.wikipedia.org/wiki/All_models_are_wrong). These are [frameworks](https://www.lesswrong.com/posts/wDP4ZWYLNj7MGXWiW/in-praise-of-fake-frameworks).)
...
>
> People believe untrue things mainly because [*reasoning is really hard*](https://www.lesswrong.com/highlights)*.* There's a whole host of cognitive biases that lead people to reason poorly.
>
...
>
> Most religions offer decent norms in areas like diet, sex, and family life. [It's hard](https://www.lesswrong.com/w/chesterton-s-fence), and historically was *extremely* hard, to figure out norms from first principles. Not all parts of the ideology are necessarily beneficial -- often most parts are useless and some parts are actively harmful -- but the good outweighs the bad.
>
...
>
> Sometimes, the utility in an ideology is mostly or purely social. Ideologies often form the basis of tribes/in-groups; [if you want to be part of the tribe, you best believe in the ideology](https://www.lesswrong.com/posts/nYkMLFpx77Rz3uo9c/belief-as-attire)! Some ideologies have a good reputation, so people can benefit by being seen as a believer in that ideology.

The "truth" view of human belief says:

> People believe in an ideology because they think it's true. Generally, the less wrong an ideology is, the more likely people are to believe it. Ideologies that are incoherent get torn down both by arguments and evidence from the real world, although [cognitive biases](https://www.lesswrong.com/w/confirmation-bias) make this process less than perfect.
>
...
Or, here's a different take on the memetic view, which is actually comes from a LW post "[Not All Beliefs Are Created Equal: Diagnosing Toxic Ideologies](https://www.lesswrong.com/posts/yuh9CtkiaBkmuLtFZ)":
...
Memetics helps us understand why people believe the things they do. It explains why ideologies are the way they are. It gives us the tools to predict if an ideology will be successful. **You cannot understand religion without memetics.** Memetics helps us understand *culture*.[^2iho0tkhr7c] **You cannot understand culture without memetics.** Memetics helps us understand social movements, fads, cults, politics. **You cannot understand politics without memetics.**
...
The modern world is really, really, complicated. There are systems [(entities, even)](https://www.lesswrong.com/posts/kbezWvZsMos6TSyfj/the-eldritch-in-the-21st-century) that dominate the world and our lives that are difficult to understand and control: culture, the economy, politics, corporations, social change. Memetics helps us understand these things.

And lastly, aren't you just curious? What *are* ideas? How are ideological movements *so freaking powerful*? There's a whole 'nother world of entities out there, entities that are *literally part of our mind*, that we use to think and perceive the world, and science hasn't even noticed them![^hq7n9ryudad] These entities are abstract in some sense and invisible and nonphysical. Or wait, are they invisible and nonphysical? What should our ontology be here?
...
> **Moloch whose name is the Mind!**[^4z0xwaq93ij][^djfl0m8q4s7]

[^s35vxhq30ro]: I'm quoting this directly from someone else. Their explanation of memetics is excellent, so I'm going to copy it. Thank you UnremediatedGenderSpace!

[^nh088dn6gcg]: https://wearehostsformemes.com/

[^eibk3lo1f]: One can replace "meme" with "memeplex" in this section and it all holds.

[^2iho0tkhr7c]: Look around -- we do not understand cultural phenomenon!

[^hq7n9ryudad]: Why isn't memetics a field of science? I'll dig into that in a future post.

[^4z0xwaq93ij]: This is a line from Allen Ginsberg's poem Howl, accessible at https://www.poetryfoundation.org/poems/49303/howl

[^djfl0m8q4s7]: (Howl is actually about memetics, although Ginsberg didn't have the vocabulary to say so.)
