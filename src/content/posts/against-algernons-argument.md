---
title: "Against Algernon's Argument"
posted: 2020-01-01
...
![Chad](https://existentialvertigocom.wordpress.com/wp-content/uploads/2022/04/image.png)

[Gwern](https://www.gwern.net/Drug-heuristics) gives a pithy summary of the argument:

> The lesson is that Mother Nature know best. Or alternately, [TANSTAAFL](https://en.wikipedia.org/wiki/TANSTAAFL): "there ain't [no such thing as a free lunch](https://en.wikipedia.org/wiki/No_free_lunch_theorem)".

[Scott](https://astralcodexten.substack.com/p/pascalian-medicine?s=r) says:
...
A SSC [commenter](https://slatestarcodex.com/2018/10/22/cognitive-enhancers-mechanisms-and-tradeoffs/) says:
...
[Gwern](https://www.gwern.net/Drug-heuristics) says:
...
[Harrypotter5777](https://www.reddit.com/r/slatestarcodex/comments/aur33i/theoretical_improvements_to_the_nervous_system/) says:
...
The Algernon Argument is a sort of [Efficient Market](https://en.wikipedia.org/wiki/Efficient-market_hypothesis) argument. "You think you can beat the market [increase your intelligence] by doing X? Well, if X did work, then the market [evolution] would have already done it. So you better have a damn good reason why thousands of genius traders [millions of years of evolution] haven't done X."
...
![Baby](https://existentialvertigocom.wordpress.com/wp-content/uploads/2022/04/image-1.png)
