---
title: "We Are Hosts for Memes (Part 2)"
posted: 2025-10-02T08:37:24.702Z
tags: ["memetics"]
part: 2
draft: false
---

![](https://39669.cdn.cke-cs.com/rQvD3VnunXZu34m86e5f/images/f89c0199c1203ff06a74bd5dadcca953ec1188a9a8fc6f2c.png)

[^jo15ww4qt3h][^17kg8kftk25]In this post, I'm going to ask you to consciously try on a new frame. You don't have to buy the frame I'm proposing; just play along for a bit. After spending a section fully in the frame, we'll return to a "neutral" frame and evaluate.

In [The Selfish Gene](https://en.wikipedia.org/wiki/The_Selfish_Gene), Dawkins presents the [gene-centered view of evolution.](https://en.wikipedia.org/wiki/Gene-centered_view_of_evolution) Typically we think (thought) of evolution and natural selection as working on the species level. Dawkins argues[^9ki48riqmj6] that evolution is best thought of as working on the gene level; genes are the unit of selection. Dawkins invites us to shift our frame into the "gene's eye view".

From the view of any particular gene, the organism is merely a vehicle for its (the gene's) reproduction. Organisms are vessels -- machines, even -- for replicating the genes that they carry. In this frame, organisms don't use genes; genes use organisms.[^mr2pmyp8sg]
...
[We are hosts for memes](https://wearehostsformemes.com/).[^0innyc4ho5pv]
...
*Quoted text is taken from the website* [*wearehostsformemes.com*](https://wearehostsformemes.com/)*.* *If you have room for more, I'd recommend checking out the full text on the website.*
...
Contagious diseases are caused by germs, pathogens that are invisible to the naked eye like bacteria, viruses, and parasites. Pathogens infect the body and use it for reproduction; they use organisms as hosts. Infected organisms spread pathogens to the those around them. Pathogens often [change behavior](https://en.wikipedia.org/wiki/Behavior-altering_parasite) in a way that makes the infected organism more likely to spread the pathogen: colds make you cough and sneeze, *Toxoplasma gondii* makes rodents attracted to the smell of cat pee. Pathogens are indifferent to whether they benefit their hosts, and as a result they usually end up harming their hosts.

Memes are like pathogens that infect our *minds* rather than our bodies. Memes spread from person to person in a manner just like pathogens. Memes that rapidly spread wide are aptly called [viral phenomenon](https://en.wikipedia.org/wiki/Viral_phenomenon). Epidemiological models of contagion spread can be applied to memetic spread; [R0](https://en.wikipedia.org/wiki/Basic_reproduction_number) can be applied to memes. Some popular ideas are seriously harmful to our thinking. It's not crazy to call them [mind viruses](https://en.wikipedia.org/wiki/Viruses_of_the_Mind). Conspiracy theories use and corrupt our faculties of reason for their own purposes; they can be likened to [parasites](https://en.wikipedia.org/wiki/Parasitism).

We have individual [memetic immune systems](https://www.lesswrong.com/w/memetic-immune-system): when someone says "that sounds like a conspiracy theory" or "that sounds like a cult", that's the memetic immune system at play. Entire cultures can develop specific antibodies in reaction to major memetic events. Consider how Western culture [reacts](https://en.wikipedia.org/wiki/Anti-fascism) to Fascism -- that's the cultural immune system learning from Nazi Germany.
...
![source: https://wearehostsformemes.com/](https://39669.cdn.cke-cs.com/rQvD3VnunXZu34m86e5f/images/67b81b701e06f2d520fe1cab0a7827439dbc96f8d6a68ffd.png)

[^jo15ww4qt3h]: Image source: https://www.thepsmiths.com/p/review-demons-by-fyodor-dostoevsky

[^17kg8kftk25]: Alternative title for this post: Ideas have you

[^9ki48riqmj6]: The Gene-centered view of evolution is now consensus.

[^mr2pmyp8sg]: Now, it's true both that organisms use genes and that genes use organisms. But from the gene's point of view, the gene is using the organism. Saying "organisms don't use genes; genes use organisms" is a way to get us into the gene-centered frame. For some people, the "organisms don't use genes" part is going to cause them to rebel and be counterproductive for entering the frame. If that's you, you don't have to say that part; instead just emphasize the "genes use organisms" part.

[^0innyc4ho5pv]: I will be quoting liberally from this website, as it perfectly captures the memes-eye view framing.

[^nb6sr6dn7rc]: I found it difficult to find this word -- the opposite of "host" is "guest", but "guest organism" seems to not be a term used outside of contexts that refer to a host? For instance, there's no Wikipedia page for "host organism". So, I asked an LLM and got "symbiont". I don't love the word, as "symbiont" comes from "symbiosis" which, while it can refer to any relationships often used as a mutalistic living together. Also: I found that not having a concept handle that included both parasitic and beneficial organism was making it hard to think about all this!

[^1vbkkp3zf9e]: But again, memes that we might consider "harmful" can also be selected for via cultural evolution, like militarism.

[^f122bfv2r09]: Note that I've changed to talking about cultural selection here. In general, it's going to be helpful to distinguish memetic selection within a culture from memetic selection between cultures -- intra-cultural memetic dynamics from inter-cultural memetic dynamics. I think of my project with memetics as being more focused on the intra-cultural; much has already been written about inter-cultural dynamics.

[^k5gwg729rw]: mutualistic
